...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Diambil</li>
@endsection
@section('content')
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title d-inline-block">Status Diambil</h5>
...
<script>
    ...
    $(document).ready(function() {
        var table_diambil = $('#diambil').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('admin.status.laporan.diambil.datatable') }}",
            },
            order : [[1,'desc']],
            columns: [
                {
        ...
        $(document).on('click','.btn-edit',function(){
            ...
            let data = table_diambil.row(tr).data();

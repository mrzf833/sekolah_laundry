...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title d-inline-block">Seluruh Transaksi</h5>
...
<script>
    ...
    $(document).ready(function() {
        var table_all = $('#all').DataTable({
            responsive: true,
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('admin.status.laporan.all.datatable') }}",
            },
            order : [[1,'desc']],
            columns: [
                {
        ...
        $(document).on('click','.btn-edit',function(){
            ...
            let data = table_all.row(tr).data();
